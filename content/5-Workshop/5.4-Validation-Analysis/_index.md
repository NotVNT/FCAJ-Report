...
{{< figure src="/images/5-Workshop/5.4-Validation-Analysis/dns-routing-site-loaded.png" alt="DNS Routing Site Loaded" caption="Money Manager application homepage at botdevgroup.me loaded successfully, confirming end-to-end DNS routing works" >}}
...
{{< figure src="/images/5-Workshop/5.4-Validation-Analysis/s3-export-notification.png" alt="S3 Export Notification" caption="Dashboard notification confirming the monthly report was successfully created and exported" >}}

{{< figure src="/images/5-Workshop/5.4-Validation-Analysis/s3-exported-report-content.png" alt="S3 Exported Report Content" caption="Content of the exported report, confirming the S3 upload/download flow works correctly" >}}
...
{{< figure src="/images/5-Workshop/5.4-Validation-Analysis/nova-money-chat-test.png" alt="Nova Money Chat Test" caption="Test conversation with Nova Money AI assistant used to generate chat data" >}}

{{< figure src="/images/5-Workshop/5.4-Validation-Analysis/dynamodb-chat-messages-scan.png" alt="DynamoDB Chat Messages Scan" caption="DynamoDB chat_messages table scan results on AWS Console confirming the test conversation was accurately stored" >}}
