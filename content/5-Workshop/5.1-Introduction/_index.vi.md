...
{{< figure src="/images/5-Workshop/5.1-Introduction/architecture-diagram.png" alt="architecture" caption="Hình 1. Sơ đồ kiến trúc tổng thể hạ tầng mạng và tích hợp dịch vụ AWS" >}}
