...
{{< figure src="/images/5-Workshop/5.3-Implementation-Steps/vpc-list.png" alt="VPC List" caption="VPC list showing custom VPC with CIDR 10.0.0.0/16" >}}
...
{{< figure src="/images/5-Workshop/5.3-Implementation-Steps/subnets-list.png" alt="Subnets List" caption="List of 6 Subnets distributed between Public and Private tiers" >}}
...
{{< figure src="/images/5-Workshop/5.3-Implementation-Steps/ec2-instances-list.png" alt="EC2 Instances List" caption="EC2 Instances list showing moneymanager-app in Running state" >}}

{{< figure src="/images/5-Workshop/5.3-Implementation-Steps/ec2-instance-detail.png" alt="EC2 Instance Detail" caption="EC2 instance moneymanager-app detail page showing Private IP address" >}}
...
{{< figure src="/images/5-Workshop/5.3-Implementation-Steps/rds-databases-list.png" alt="RDS Databases List" caption="RDS Databases list with db-moneymanager MySQL 8.0 instance" >}}

{{< figure src="/images/5-Workshop/5.3-Implementation-Steps/rds-instance-detail.png" alt="RDS Instance Detail" caption="RDS instance detail page, Connectivity & security tab" >}}
...
{{< figure src="/images/5-Workshop/5.3-Implementation-Steps/elasticache-redis-list.png" alt="ElastiCache Redis List" caption="ElastiCache Redis OSS caches list with moneymanager-redis cluster" >}}

{{< figure src="/images/5-Workshop/5.3-Implementation-Steps/elasticache-cluster-detail.png" alt="ElastiCache Cluster Detail" caption="ElastiCache moneymanager-redis cluster detail page" >}}
...
{{< figure src="/images/5-Workshop/5.3-Implementation-Steps/dynamodb-tables-list.png" alt="DynamoDB Tables List" caption="DynamoDB Tables list showing chat_messages and chat_sessions" >}}

{{< figure src="/images/5-Workshop/5.3-Implementation-Steps/dynamodb-chat-messages-detail.png" alt="DynamoDB Chat Messages Detail" caption="chat_messages table detail page" >}}

{{< figure src="/images/5-Workshop/5.3-Implementation-Steps/dynamodb-chat-sessions-detail.png" alt="DynamoDB Chat Sessions Detail" caption="chat_sessions table detail page" >}}
...
{{< figure src="/images/5-Workshop/5.3-Implementation-Steps/sqs-queues-list.png" alt="SQS Queues List" caption="SQS Queues list showing moneymanager-async-jobs and corresponding DLQ" >}}

{{< figure src="/images/5-Workshop/5.3-Implementation-Steps/sqs-main-queue-detail.png" alt="SQS Main Queue Detail" caption="Main queue moneymanager-async-jobs detail page" >}}

{{< figure src="/images/5-Workshop/5.3-Implementation-Steps/sqs-dlq-detail.png" alt="SQS DLQ Detail" caption="Dead Letter Queue moneymanager-async-jobs-dlq detail page" >}}
...
{{< figure src="/images/5-Workshop/5.3-Implementation-Steps/s3-buckets-list.png" alt="S3 Buckets List" caption="S3 Buckets list showing botdevgroup-documents and the project's static website bucket" >}}

{{< figure src="/images/5-Workshop/5.3-Implementation-Steps/s3-documents-bucket-objects.png" alt="S3 Documents Bucket Objects" caption="Objects stored in the botdevgroup-documents bucket" >}}

{{< figure src="/images/5-Workshop/5.3-Implementation-Steps/s3-website-bucket-objects.png" alt="S3 Website Bucket Objects" caption="Objects stored in the botdevgroup.me static website bucket" >}}
...
{{< figure src="/images/5-Workshop/5.3-Implementation-Steps/vpc-dashboard-list.png" alt="VPC Dashboard List" caption="VPC dashboard listing VPCs used for configuring Interface Endpoint PrivateLink" >}}

{{< figure src="/images/5-Workshop/5.3-Implementation-Steps/vpc-resource-map.png" alt="VPC Resource Map" caption="Resource map of botdevgroup-vpc showing Subnets, Route Tables, and Endpoint connections" >}}
