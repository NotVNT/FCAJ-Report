...
{{< figure src="/images/5-Workshop/5.2-Prerequisite/iam-access-key-creation.png" alt="IAM Access Key" caption="IAM Security credentials tab with Access keys section for creating CLI connection keys" >}}
